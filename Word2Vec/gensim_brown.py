...
class WikiTester:
    ...
    def load_model(self, new_list):
        ...
        sentences = sentences + new_list
        self.model = gensim.models.Word2Vec(sentences, min_count=1, size=500, sg=1, hs=0, iter=2)
        self.model.save('D:/Studies/USC/3rdSem/CSCI544/GroupProjectData/BrownCorpusModelSkipgram')
        self.model = Word2Vec.load('D:/Studies/USC/3rdSem/CSCI544/GroupProjectData/BrownCorpusModelSkipgram')
    ...
    def readfile(self):
        ...
        for key in self.avg_model_answer_vector.keys():
            ...
            writer = open('D:/Studies/USC/3rdSem/CSCI544/GroupProjectData/OutputFolderBrownSkipGram/' + key + '.txt', 'w')
